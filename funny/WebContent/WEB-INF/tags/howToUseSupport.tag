...
<h3 class="h3support">후원금은 이렇게 사용됩니다</h3>
	<div class="container">
		<div class="row row-pb-md support">
			<div class="col footer-col colorlib-widget">
				<img src="images/supportEX1.jpg" class="img-fluid animals"
			...
			<div class="col footer-col colorlib-widget">
				<img src="images/supportEX2.jpg" class="img-fluid animals"
					alt="Free html5 bootstrap 4 template">
				<h4>구조 · 구호</h4>
			...
			<div class="col footer-col colorlib-widget">
				<img src="images/supportEX3.jpg" class="img-fluid animals"
					alt="Free html5 bootstrap 4 template">
				<h4>아카이빙</h4>
	...
	<div class="container" style="margin-bottom: 14em;">
		<div class="row row-pb-md support">
			<div class="col footer-col colorlib-widget">
				<img src="images/supportEX4.jpg" class="img-fluid animals"
					alt="Free html5 bootstrap 4 template">
				<h4>문화활동 및 캠페인</h4>
			...
			<div class="col footer-col colorlib-widget">
				<img src="images/supportEX5.jpg" class="img-fluid animals"
					alt="Free html5 bootstrap 4 template">
				<h4>법 · 정책 연구 및 제안</h4>
			...
			<div class="col footer-col colorlib-widget">
				<img src="images/supportEX6.jpg" class="img-fluid animals"
					alt="Free html5 bootstrap 4 template">
				<h4>학대대응</h4>
